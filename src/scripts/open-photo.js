/**
 * Photo Open Transition Hook — Alba Tull V6A
 *
 * Connects the repeating-frame transition to the overlay router.
 * When a photo tile is clicked, waits for the overlay hero image
 * to appear, then runs the transition from tile → hero position.
 *
 * Preloads the image on hover to eliminate the delay between
 * click and transition start.
 */
