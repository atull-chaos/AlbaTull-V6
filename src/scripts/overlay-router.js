/**
 * Overlay + Route Router — Alba Tull V6A
 *
 ...
 *
 * DOM contract:
 *   #stage-overlay            — the overlay wrapper
 *   [data-overlay-close]      — close buttons inside the overlay
 *   [data-overlay-body]       — container for injected content
 *   a[data-overlay-link]      — any link that should open in the overlay
 */
...
export function initOverlayRouter() {
  ...
  // Intercept clicks on overlay-routed links
